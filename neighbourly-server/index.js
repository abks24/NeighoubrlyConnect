...
// send email with nodemailer using Ethereal test account (for dev)
const sendEmail = async (emailAddress, emailData) => {
  try {
    ...
    const mailBody = {
      from: `"Neighbourly" <no-reply@neighbourly.com>`,
      to: emailAddress,
...
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@cluster0.vzvgjdj.mongodb.net/neighbourly?retryWrites=true&w=majority&appName=Cluster0`;
